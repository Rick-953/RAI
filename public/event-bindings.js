...
(function installRaiEventBindings() {
  ...
  const ALLOWED_ACTIONS = new Set([
    ...
    'autoLayoutNodes', 'autoResizeChatFlowInput', 'autoResizeInput', 'bindZtx6dAccount',
    ...
    'copyInviteLink', 'copyMermaidCode', 'copyTwoFactorSecret', 'createNewFlow',
    ...
    'handleChatFlowInputKeydown', 'handleComposerMenuItemKeydown', 'handleEmailCodeKeydown',
    ...
    'loadSessionMessages', 'loginWithPasskey', 'logoutAllSecurityDevices', 'markRaiNotificationsRead',
    ...
    'selectChatFlowModel', 'selectModelFromMenu',
    'selectRaiModeFromMenu', 'selectSpace', 'sendAdminBroadcastAll', 'sendAdminBroadcastTest',
    'sendChatFlowMessage', 'setAuthLoginMethod', 'setCanvasTool', 'setFontPreference',
    ...
    'startTwoFactorSetup', 'startZtx6dLogin', 'stopChatFlowGeneration', 'stopGeneration',
    'switchAdminTab', 'switchAuthMode', 'switchSettingsSection', 'toggleAdminModel',
    'toggleAllModels', 'toggleChatFlowInternet', 'toggleChatFlowModelMenu',
    'toggleChatFlowPatchMode', 'toggleChatFlowThinking', 'toggleExportMenu', 'toggleGroup',
    ...
    'toggleResearchAgentModel', 'toggleResearchModeFromMenu', 'toggleSidebar', 'toggleTheme',
    'toggleThinkingFromMenu', 'undoLastCanvasPatch', 'updateSliderValue',
