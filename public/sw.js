const RAI_SW_VERSION = '0.14.4-20260819-pet-imgfix-v0141-r1';
...
const RAI_STATIC_ASSETS = [
  ...
  'app.js?v=20260819-pet-imgfix-v0141-r1', 'styles.css?v=20260819-pet-imgfix-v0141-r1',
  'local-agent.js?v=20260819-pet-imgfix-v0141-r1', 'local-agent.css?v=20260818-version-contract-v0136-r1',
  ...
  'pet-quotes.js?v=20260819-pet-imgfix-v0141-r1',
