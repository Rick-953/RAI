const RAI_SW_VERSION = '0.14.2-20260818-pet-smooth-v0139-r1';
...
const RAI_STATIC_ASSETS = [
  ...
  'app.js?v=20260818-pet-smooth-v0139-r1', 'styles.css?v=20260818-pet-smooth-v0139-r1',
  'local-agent.js?v=20260818-pet-smooth-v0139-r1', 'local-agent.css?v=20260818-version-contract-v0136-r1',
  ...
  'pet-quotes.js?v=20260818-pet-smooth-v0139-r1',
