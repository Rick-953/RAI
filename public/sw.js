const RAI_SW_VERSION = '0.13.11-20260819-persisted-flow-dedupe-v01311-r1';
...
const RAI_STATIC_ASSETS = [
  '', 'index.html', 'runtime-brand.js?v=20260819-persisted-flow-dedupe-v01311-r1',
  'rai-system-prompt.js?v=20260819-persisted-flow-dedupe-v01311-r1', 'event-bindings.js?v=20260819-persisted-flow-dedupe-v01311-r1',
  'app.js?v=20260819-persisted-flow-dedupe-v01311-r1', 'styles.css?v=20260819-persisted-flow-dedupe-v01311-r1',
  'local-agent.js?v=20260819-persisted-flow-dedupe-v01311-r1', 'local-agent.css?v=20260819-persisted-flow-dedupe-v01311-r1',
  'crf-ui.js?v=20260819-persisted-flow-dedupe-v01311-r1',
  'selection-explainer.js?v=20260819-persisted-flow-dedupe-v01311-r1', 'selection-explainer.css?v=20260819-persisted-flow-dedupe-v01311-r1',
  'site.webmanifest?v=20260819-persisted-flow-dedupe-v01311-r1', 'icons/source-search.svg', 'icons/rai-app-icon.svg',
  ...
  'lib/marked.min.js?v=20260819-persisted-flow-dedupe-v01311-r1', 'lib/purify.min.js?v=20260819-persisted-flow-dedupe-v01311-r1',
  'lib/katex/katex.min.css?v=20260819-persisted-flow-dedupe-v01311-r1', 'lib/katex/katex.min.js?v=20260819-persisted-flow-dedupe-v01311-r1',
  'lib/katex/contrib/auto-render.min.js?v=20260819-persisted-flow-dedupe-v01311-r1',
  'lib/highlight/styles/github-dark.min.css?v=20260819-persisted-flow-dedupe-v01311-r1',
  'lib/highlight/highlight.min.js?v=20260819-persisted-flow-dedupe-v01311-r1'
].map(appPath);
