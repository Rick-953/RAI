const RAI_SW_VERSION = '0.13.1-20260814-local-agent-install-v01301-r3';
...
const RAI_STATIC_ASSETS = [
  '', 'index.html', 'runtime-brand.js?v=20260814-local-agent-install-v01301-r3',
  'rai-system-prompt.js?v=20260814-local-agent-install-v01301-r3', 'event-bindings.js?v=20260814-local-agent-install-v01301-r3',
  'app.js?v=20260814-local-agent-install-v01301-r3', 'styles.css?v=20260814-local-agent-install-v01301-r3',
  'local-agent.js?v=20260814-local-agent-install-v01301-r3', 'local-agent.css?v=20260814-local-agent-install-v01301-r3',
  'crf-ui.js?v=20260814-local-agent-install-v01301-r3',
  'selection-explainer.js?v=20260814-local-agent-install-v01301-r3', 'selection-explainer.css?v=20260814-local-agent-install-v01301-r3',
  'site.webmanifest?v=20260814-local-agent-install-v01301-r3', 'icons/source-search.svg', 'icons/rai-app-icon.svg',
  ...
  'lib/marked.min.js?v=20260814-local-agent-install-v01301-r3', 'lib/purify.min.js?v=20260814-local-agent-install-v01301-r3',
  'lib/katex/katex.min.css?v=20260814-local-agent-install-v01301-r3', 'lib/katex/katex.min.js?v=20260814-local-agent-install-v01301-r3',
  'lib/katex/contrib/auto-render.min.js?v=20260814-local-agent-install-v01301-r3',
  'lib/highlight/styles/github-dark.min.css?v=20260814-local-agent-install-v01301-r3',
  'lib/highlight/highlight.min.js?v=20260814-local-agent-install-v01301-r3'
].map(appPath);
