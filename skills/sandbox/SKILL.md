...
The sandbox is a short-lived, low-overhead Linux workspace. It can run shell commands and code without network access or host access.
...
- The sandbox has no network, credentials, package installation, host filesystem, service manager, kernel interfaces, or persistent home directory.
