...
const staticIndexBindingCount = verifyDeclarativeBindings('public/index.html', indexHtml, 176);
check(staticIndexBindingCount === 176, `public/index.html binding baseline changed unexpectedly (${staticIndexBindingCount} != 176)`);
