...
function testVersionContract() {
  ...
  const expectedBuild = '20260921-ios-upload-pwa-fixes-v0144-r1';
  ...
  assert.match(app, /const RAI_BUILD_ID = '20260921-ios-upload-pwa-fixes-v0144-r1'/);
  assert.match(index, new RegExp(`by Rick \\u00b7 v${expectedVersion.replaceAll('.', '\\.')}`));
  assert.match(serviceWorker, new RegExp(`${expectedVersion.replaceAll('.', '\\.')}-20260921-ios-upload-pwa-fixes-v0144-r1`));
  ...
  assert.match(index, /conversation-cache\.js\?v=20260921-ios-upload-pwa-fixes-v0144-r1/);
