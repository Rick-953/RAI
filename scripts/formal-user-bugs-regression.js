...
function testVersionContract() {
  ...
  const expectedBuild = '20260814-local-agent-install-v01301-r2';
  ...
  assert.match(app, /const RAI_BUILD_ID = '20260814-local-agent-install-v01301-r2'/);
  assert.match(index, new RegExp(`by Rick \\u00b7 v${expectedVersion.replaceAll('.', '\\.')}`));
  assert.match(serviceWorker, /0.13.1-20260814-local-agent-install-v01301-r2/);
  ...
  assert.match(index, /conversation-cache\.js\?v=20260814-local-agent-install-v01301-r2/);
