...
function testVersionContract() {
  const expectedVersion = '0.12.2';
  const expectedBuild = '20260814-mobile-guide-layout-v01202-r2';
  ...
  assert.match(app, /const RAI_BUILD_ID = '20260814-mobile-guide-layout-v01202-r2'/);
  assert.match(index, new RegExp(`by Rick \\u00b7 v${expectedVersion.replaceAll('.', '\\.')}`));
  assert.match(serviceWorker, /0.12.2-20260814-mobile-guide-layout-v01202-r2/);
  ...
  assert.match(index, /conversation-cache\.js\?v=20260814-mobile-guide-layout-v01202-r2/);
