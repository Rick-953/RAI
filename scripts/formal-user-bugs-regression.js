...
function testVersionContract() {
  ...
  const expectedBuild = '20260908-ios-standalone-safe-area-v0137-r1';
  ...
  assert.match(app, /const RAI_BUILD_ID = '20260908-ios-standalone-safe-area-v0137-r1'/);
  assert.match(index, new RegExp(`by Rick \\u00b7 v${expectedVersion.replaceAll('.', '\\.')}`));
  assert.match(serviceWorker, new RegExp(`${expectedVersion.replaceAll('.', '\\.')}-20260908-ios-standalone-safe-area-v0137-r1`));
  ...
  assert.match(index, /conversation-cache\.js\?v=20260908-ios-standalone-safe-area-v0137-r1/);
