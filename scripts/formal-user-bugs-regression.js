...
function testVersionContract() {
  ...
  const expectedBuild = '20260921-2fa-drift-ios-viewport-v0145-r1';
  ...
  assert.match(app, /const RAI_BUILD_ID = '20260921-2fa-drift-ios-viewport-v0145-r1'/);
  assert.match(index, new RegExp(`by Rick \\u00b7 v${expectedVersion.replaceAll('.', '\\.')}`));
  assert.match(serviceWorker, new RegExp(`${expectedVersion.replaceAll('.', '\\.')}-20260921-2fa-drift-ios-viewport-v0145-r1`));
  ...
  assert.match(index, /conversation-cache\.js\?v=20260921-2fa-drift-ios-viewport-v0145-r1/);
