...
function testVersionContract() {
  const expectedVersion = '0.11.99';
  const expectedBuild = '20260813-tea-pet-v01199-r3';
  ...
  assert.match(app, /const RAI_APP_VERSION = '0\.11\.99'/);
  assert.match(app, /const RAI_BUILD_ID = '20260813-tea-pet-v01199-r3'/);
  assert.match(index, /by Rick \u00b7 v0\.11\.99/);
  assert.match(serviceWorker, /0\.11\.99-20260813-tea-pet-v01199-r3/);
  ...
  assert.match(index, /conversation-cache\.js\?v=20260813-tea-pet-v01199-r3/);
