...
function testVersionContract() {
  ...
  const expectedBuild = '20260818-stream-timeline-v0138-r1';
  ...
  assert.match(app, /const RAI_BUILD_ID = '20260818-stream-timeline-v0138-r1'/);
  assert.match(index, new RegExp(`by Rick \\u00b7 v${expectedVersion.replaceAll('.', '\\.')}`));
  assert.match(serviceWorker, /0\.13\.8-20260818-stream-timeline-v0138-r1/);
  ...
  assert.match(index, /conversation-cache\.js\?v=20260818-stream-timeline-v0138-r1/);
