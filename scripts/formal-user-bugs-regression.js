...
function testVersionContract() {
  const expectedVersion = '0.11.98';
  const expectedBuild = '20260813-onboarding-account-isolation-v01198-r1';
  ...
  assert.match(app, /const RAI_APP_VERSION = '0\.11\.98'/);
  assert.match(app, /const RAI_BUILD_ID = '20260813-onboarding-account-isolation-v01198-r1'/);
  assert.match(index, /by Rick \u00b7 v0\.11\.98/);
  assert.match(serviceWorker, /0\.11\.98-20260813-onboarding-account-isolation-v01198-r1/);
  ...
  assert.match(index, /conversation-cache\.js\?v=20260813-onboarding-account-isolation-v01198-r1/);
