...
function testVersionContract() {
  ...
  const expectedBuild = '20260819-persisted-flow-dedupe-v01311-r1';
  ...
  assert.match(app, /const RAI_BUILD_ID = '20260819-persisted-flow-dedupe-v01311-r1'/);
  assert.match(index, new RegExp(`by Rick \\u00b7 v${expectedVersion.replaceAll('.', '\\.')}`));
  assert.match(serviceWorker, /0\.13\.11-20260819-persisted-flow-dedupe-v01311-r1/);
  ...
  assert.match(index, /conversation-cache\.js\?v=20260819-persisted-flow-dedupe-v01311-r1/);
